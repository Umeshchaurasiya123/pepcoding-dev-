...
function primeSieve(phandler, nphandler) //primehandler  nonprimehandler 
 {
    let oarr = this;
    phandler.calledForTheFirstTime = true;  // it is like  function as object and adding value to it by.
...
// here basically we bind prieSieve to sieve 
// i.e Array.prototype.sieve=function(){... }
// here that function is here in name called primeSieve()
