(function(){
    ...
    function viewTextFile(){
        ...
        let divNotepadMenuTemplates=templates.content.querySelector("[purpose=notepad-menu]");
        let divNotepadMenu=document.importNode(divNotepadMenuTemplates,true);

        divAppMenuBar.innerHTML="";
        divAppMenuBar.appendChild(divNotepadMenu);

        let divNotepadBodyTemplates=templates.content.querySelector("[purpose=notepad-body]");
        let divNotepadBody=document.importNode(divNotepadBodyTemplates,true);
        ...
        inputBGColor.addEventListener("change",changeNotepadeBGColor);
        inputTextColor.addEventListener("change",changeNotepadeTextColor)
    ...
    function makeNotepadBold(){
        ...
        if(isPressed==false){
            ...
            this.setAttribute("pressed",fasle);
            textArea.style.fontWeight="normal";
        }
    }

    function makaNotepadItalic(){
        let textArea=divAppBody.querySelector("textarea");
    ...
    function changeNotepadeBGColor(){
        let color=this.value;
        let textArea=divAppBody.querySelector("textarea");
        textArea.style.background=color;
    }

    function changeNotepadeTextColor(){
        let color=this.value;
        let textArea=divAppBody.querySelector("textarea");
